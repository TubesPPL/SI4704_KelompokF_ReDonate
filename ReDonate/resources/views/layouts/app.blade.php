...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'ReDonate') }}</title>

        <link rel="icon" type="image/png" href="{{ asset('images/redonate-logo.jpeg') }}">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                        <div class="col-span-1 md:col-span-2">
                            <a href="{{ route('home') }}" class="flex items-center gap-2 mb-4">
                                ...
                                <span class="font-bold text-2xl text-white">Re<span class="text-teal-500">Donate</span></span>
                            </a>
                            <p class="text-gray-400 text-sm max-w-md leading-relaxed">
                                Platform donasi barang layak pakai yang menghubungkan niat baik dengan mereka yang membutuhkan. Jadikan barang bekasmu berkah untuk orang lain.
                            </p>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold mb-4 text-gray-200">Navigasi</h3>
                            <ul class="space-y-2 text-sm text-gray-400">
                                <li><a href="{{ route('home') }}" class="hover:text-teal-400 transition">Beranda</a></li>
                                <li><a href="#" class="hover:text-teal-400 transition">Katalog Donasi</a></li>
                                <li><a href="#" class="hover:text-teal-400 transition">Event Donasi</a></li>
                                <li><a href="#how-it-works" class="hover:text-teal-400 transition">Cara Kerja</a></li>
                            </ul>
                        </div>
                        <div>
                            <h3 class="text-lg font-semibold mb-4 text-gray-200">Dukungan</h3>
                            <ul class="space-y-2 text-sm text-gray-400">
                                <li><a href="#" class="hover:text-teal-400 transition">Bantuan & FAQ</a></li>
                                ...
                                <li><a href="#" class="hover:text-teal-400 transition">Kontak Kami</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="border-t border-gray-800 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p class="text-gray-500 text-sm">
                            &copy; {{ date('Y') }} ReDonate. Hak Cipta Dilindungi.
                        </p>
